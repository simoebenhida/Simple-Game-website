...
<dl><dt>Code de <?php if($paiement == 'wafacash'){
echo 'wafacash';}
else
{
	...
	{
	echo 'western union';}
}?>:</dt><dd><input type="text" class="w300 txt mr10" name="codepaiement" value="<?php if($codepaiement != NULL) {
											echo $codepaiement;}
											else
											{ echo "";}?>" ></dd></dl>
...
<dl><dt>Utilisateur LOL:</dt><dd><input type="text" class="w300 txt mr10" name="utilisateur" value="<?php if($utilisateur != NULL) {
							...
							<a href="commandes" ><button type="button" class="button button-rounded button-action pull-left">Annuler</button></a>
