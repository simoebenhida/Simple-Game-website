	...
	<div class="box box-solid">
            <div class="box-header with-border">
              ...
              <ul>
                ...
                <li>Il faut créer une commande.</li>
                <li>Après la création de commande, le fournisseur doit contacter notre support en ligne. Après discussion, le support vous indique s'il accepte de prendre votre livraison.</li>
                <li>Il va vous donner la position et le nom du personage pour l’échange.</li>
                <li>Avant que vous ne donniez les kamas au personnage, il vous donnera l'adresse email de votre compte. Vous devez verifier qu'il s'agit du bon email pour éviter des arnaqueurs.</li>
                <li>Nous allons vous payer via ce que vous avez choisis en 24H sauf weekends et jours fériés.</li>
