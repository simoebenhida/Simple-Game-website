...
?>
		...
		<img src="images/steam.jpg" width="1349px" height="250px" alt="" />
 ...
 if (strlen($_POST["mdp"]) < 7) {
    ...
    if ((($_POST['mdp']) != ($_POST['mdp2'])) && ($existeDeja == false)) {
        ?>   <div class="alert alert-danger alert-dismissible">
                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                <h4><i class="icon fa fa-ban"></i> Alert!</h4>
                La vérification de mot de passe ne correspond pas au mot de passe précédemment saisi.
              </div>
...
if(isset($_POST["g-recaptcha-response"])) {
  ...
  logRightAfterRegister($_POST['email']);
		echo '<script language="Javascript">
...
document.location.replace("index.php");
 ...
 ?>
			...
			<h2 class="title text-center">Creer un Nouveau Compte!</h2>
